        ...
        <div className="navbar bg-green-700 shadow-sm">
            ...
            <div className="navbar-center">
                <Link className=" text-xl flex-col text-center" to="/Property">
                    <h1>Celtica</h1>
                    <img src="/CelticLogo.png" alt="" className='h-36'/>
                </Link>
            </div>
    ...
    <div className="bg-yellow-500 shadow">
            <ul className="menu menu-horizontal px-4">
                ...
                <details>
                    ...
                    <li><a>Books</a></li>
                    <li><a>Store</a></li>
                    <li><a>Illustrated Books</a></li>
                    <li><a>Education Books</a></li>
                    <li><a>Comics</a></li>
                    ...
                    <li><a>Papers</a></li>
                    <li><a>Libraries</a></li>
                    <li><a>Publishing Orders</a></li>
                    <li><a>Ink</a></li>
                    <li><a>printing press</a></li>
                    <li><a>Manuscripts</a></li>
                    <li><a>Book Rental</a></li>
                    <li><a>Donate Books</a></li>
                    <li><a>Translations</a></li>
                    <li><a>Translation Donation</a></li>
                    <li><a>Studies</a></li>
    ...
    return(
        <>
            <div className="min-h-screen flex flex-col">
                ...
                <div className='flex'>
                    <img src="/Celtica/CelticHair.jpg" alt="" />
                    <img src="/Celtica/CelticWarrior.jpg" alt="" />
                    <img src="/Celtica/CelticFace.jpg" alt="" />
